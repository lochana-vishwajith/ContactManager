...
class Contact extends Component {
    ...
    onDeleteClick = async (id,dispatch)=>{
       const re = await axios.delete(`https://jsonplaceholder.typicode.com/users/${id}`)
            ...
            <Consumer>
                {value => {
                    ...
                    return(
                        ...
                        <h4>{name} <i className = "fas fa-sort-down" style={{cursor: 'pointer'}} onClick={() => this.setState({showContactInfo:!this.state.showContactInfo})} />
